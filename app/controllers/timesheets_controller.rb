class TimesheetsController < ApplicationController
  ...
  def new
    ...
    @employees = Employee.order(:firstname)
    @employees.size.times {@timesheet.line_employees.build}
  end
  ...
  def create
    ...
    @timesheet.user_id = current_user.id if current_user
  ...
  private
    ...
    def timesheet_params
      params.require(:timesheet).permit(:sector_id, { line_employees_attributes: [:id, :employee_id, :status] })
    end
end
