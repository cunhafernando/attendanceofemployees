class UsersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @user.save
        format.html { redirect_to users_url, notice: "O usuário foi criado com sucesso." }
  ...
  private
    ...
    def user_params
      params.require(:user).permit(:username, :firstname, :lastname, :registration, :role, :password)
    end
end
